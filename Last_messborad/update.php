<?php
    ...
    $id=$_GET["id"]; 
    /*SQL語法 取出與接收id相同的資料 */
    $query = "SELECT `title`,`Description` FROM `note` WHERE `id`=$id";
			...
			<form method="POST" action="
					<?php 
                      ...
                      foreach($result as $row ){ 
                            echo "update_fn.php?id=",$row["id"],"";
                      }
                    ?>">
			<td width="100%">
				<div class="mb-3">
  					<label class="form-label">標題:</label>
					<input type="text" name="title" class="form-control" value=<?php echo $title_o; ?> aria-describedby="basic-addon2">
				</div>
			</td>
		</tr>
		<tr align=left>
			<td width="100%">
				<div class="mb-3">
					...
					<textarea class="form-control" clos="50" rows="10" name="des"><?php echo $des_o; ?></textarea>
				</div>
			</td>
		</tr>
		<tr align=center>
